...
const { authenticateUser, authorizeCustomer } = require('../middleware/authenticate');
const {
    addToCart,
    updateCartItem,
    removeCartItem,
...
router.post('/cart/place-order', authenticateUser, authorizeCustomer, placeOrder); // Place order from cart
